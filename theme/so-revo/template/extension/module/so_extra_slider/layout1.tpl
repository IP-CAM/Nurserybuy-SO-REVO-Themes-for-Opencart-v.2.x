...
//Dev custom: moduleclass_sfx
$moduleclass_sfx = explode("fa-", $class_suffix);
if(isset($moduleclass_sfx[1])) $icon = 'fa fa-'.trim($moduleclass_sfx[1]);
else $icon = 'fa fa-diamond';
...
<div class="moduletable module <?php echo $class_suffix; ?>">
		...
		<h3 class="modtitle"><span><i class="<?php echo $icon; ?>"></i> <?php echo $head_name; ?> </span></h3>
