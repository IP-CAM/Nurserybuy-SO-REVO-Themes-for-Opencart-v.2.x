...
if (isset($customisation_general[$lang]["sale_text"][$store_id])) {$customisation_general[$lang]["sale_text"] = $customisation_general[$lang]["sale_text"][$store_id];}
if (isset($customisation_general[$lang]["new_text"][$store_id])) {$customisation_general[$lang]["new_text"] = $customisation_general[$lang]["new_text"][$store_id];}
if (isset($customisation_general[$lang]["quick_view_text"][$store_id])) {$customisation_general[$lang]["quick_view_text"] = $customisation_general[$lang]["quick_view_text"][$store_id];}
...
if (isset($customisation_general["additional_page_status"][$store_id])) {$customisation_general["additional_page_status"] = $customisation_general["additional_page_status"][$store_id];}
...
if (isset($customisation_translation[$lang]["countdown_title"][$store_id])) {$customisation_translation[$lang]["countdown_title"] = $customisation_translation[$lang]["countdown_title"][$store_id];}
if (isset($customisation_translation[$lang]["countdown_title_day"][$store_id])) {$customisation_translation[$lang]["countdown_title_day"] = $customisation_translation[$lang]["countdown_title_day"][$store_id];}
if (isset($customisation_translation[$lang]["countdown_title_hour"][$store_id])) {$customisation_translation[$lang]["countdown_title_hour"] = $customisation_translation[$lang]["countdown_title_hour"][$store_id];}
if (isset($customisation_translation[$lang]["countdown_title_minute"][$store_id])) {$customisation_translation[$lang]["countdown_title_minute"] = $customisation_translation[$lang]["countdown_title_minute"][$store_id];}
if (isset($customisation_translation[$lang]["countdown_title_second"][$store_id])) {$customisation_translation[$lang]["countdown_title_second"] = $customisation_translation[$lang]["countdown_title_second"][$store_id];}
